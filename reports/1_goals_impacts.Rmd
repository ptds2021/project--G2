...
The objective is to design a optimisation algorithm that would generate all possible timetables from a choice of possible classes. From our prespective of Master students in Management at HEC Lausanne, following the track "Business Analytics", we face every semester the following challenge, in the sense that we must choose classes that account for 3 constraints: 
- the **time constraints** (clashing classes on the schedule are impossible to take), 
