...
software which, according to the courses a student has choosen, displays
in green and blue how some courses overlap, as well as some information
in red also about the course availability.

![Screenshot of the program students at Tecnologico de Monterrey uses to
make their semester
schedule.](/project--G2/pictures/tec_timetable1.jpef)

```{r, echo = FALSE, warning=FALSE, out.height="50%"}
knitr::include_graphics(here::here("pictures/tec_timetable1.jpeg")) 
```

Although this is useful for students, it can still take a while to get a
"doable" timetable right. We want to tackle this problem here. 
...
8-12 on Monday), so we need specific modeling.
